...
#define resetButtonString ICON_LC_ROTATE_CCW
#define devicesButtonString ICON_LC_HARD_DRIVE
#define editPathButtonString ICON_LC_PENCIL
#define searchString ICON_LC_SEARCH
...
#define placesButtonString ICON_LC_HARD_DRIVE
#define placesButtonHelpString "Show all devices"
