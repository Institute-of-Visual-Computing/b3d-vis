...
TextureD3D11::TextureD3D11(void* unityTextureHandle) : Texture(unityTextureHandle)
{
	assert(unityTextureHandle != nullptr);

	d3d11GraphicsResource_ = static_cast<ID3D11Texture2D*>(unityTextureHandle);
...
void TextureD3D11::registerCUDA()
{
