...
b3d::unity_cuda_interop::runtime::RenderingContext_D3D11::RenderingContext_D3D11(PluginLogger* logger,
...
auto b3d::unity_cuda_interop::runtime::RenderingContext_D3D11::signal(SyncPrimitive* syncPrimitive, unsigned value)
	-> void
{
...
auto b3d::unity_cuda_interop::runtime::RenderingContext_D3D11::wait(SyncPrimitive* syncPrimitive, unsigned value) -> void
{
	const auto syncPrimitiveD3D11 = static_cast<SyncPrimitiveD3D11*>(syncPrimitive);
